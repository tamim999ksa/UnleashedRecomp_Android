...
#define PPC_MM_LOAD_U8(x, pc) (IsMMIO(x) ? MMIO_Read8(x, pc) : PPC_LOAD_U8(x))
#endif

#ifndef PPC_MM_LOAD_U16
#define PPC_MM_LOAD_U16(x, pc) (IsMMIO(x) ? MMIO_Read16(x, pc) : PPC_LOAD_U16(x))
#endif

#ifndef PPC_MM_LOAD_U32
#define PPC_MM_LOAD_U32(x, pc) (IsMMIO(x) ? MMIO_Read32(x, pc) : PPC_LOAD_U32(x))
#endif

#ifndef PPC_MM_LOAD_U64
#define PPC_MM_LOAD_U64(x, pc) (IsMMIO(x) ? MMIO_Read64(x, pc) : PPC_LOAD_U64(x))
#endif
...
#define PPC_MM_STORE_U8(x, y, pc)   (IsMMIO(x) ? MMIO_Write8(x, y, pc) : (void)(PPC_STORE_U8(x, y)))
#endif

#ifndef PPC_MM_STORE_U16
#define PPC_MM_STORE_U16(x, y, pc)  (IsMMIO(x) ? MMIO_Write16(x, y, pc) : (void)(PPC_STORE_U16(x, y)))
#endif

#ifndef PPC_MM_STORE_U32
#define PPC_MM_STORE_U32(x, y, pc)  (IsMMIO(x) ? MMIO_Write32(x, y, pc) : (void)(PPC_STORE_U32(x, y)))
#endif

#ifndef PPC_MM_STORE_U64
#define PPC_MM_STORE_U64(x, y, pc)  (IsMMIO(x) ? MMIO_Write64(x, y, pc) : (void)(PPC_STORE_U64(x, y)))
#endif
...
extern const uint8_t VectorMaskL[];
extern const uint8_t VectorMaskR[];
extern const uint8_t VectorShiftTableL[];
extern const uint8_t VectorShiftTableR[];
